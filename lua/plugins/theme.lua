-- 查看颜色高亮 :Inspect
-- 临时禁用光标移入高亮 :hi! LspReferenceText guibg=NONE guifg=NONE
return {
  ...
  opts = {
    ...
    on_highlights = function(hl)
      ...
      hl.LspReferenceWrite = { bg = "#000000", fg = "#c0f000" }
      hl.LspReferenceText = { bg = "#000000", fg = "#c0a000" }
      hl.LspReferenceRead = { bg = "#000000", fg = "#c0a000" }
      ...
      hl.javaScriptReserved = { fg = "#305030" }
      ...
      hl.javaScriptParens = { fg = "#005000" }
      hl.javaScriptConditional = { fg = "#006030" }
      hl.javaScriptBraces = { fg = "#306030" }
      hl["@lsp.typemod.function.defaultLibrary"] = { fg = "#009000" }
      hl["@lsp.typemod.struct.defaultLibrary"] = { fg = "#009000" }
      hl["@lsp.typemod.method.defaultLibrary"] = { fg = "#009000" }
      hl["@lsp.typemod.macro.defaultLibrary"] = { fg = "#009000" }

      hl["@lsp.type.variable"] = { fg = "#50c000" }
      hl["@lsp.type.method"] = { fg = "#30a000" }
